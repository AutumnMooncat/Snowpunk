...
public class DrawCardsMod extends AbstractCardEffectMod {
    public DrawCardsMod(String description, AbstractCoreCard.ValueType type, int effect, int upEffect, boolean secondVar) {
    ...
    public AbstractCardModifier makeCopy() {
        return new DrawCardsMod(description, type, effect, upEffect, useSecondVar);
    }
}
