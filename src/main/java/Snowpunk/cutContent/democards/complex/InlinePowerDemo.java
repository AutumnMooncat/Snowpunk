...
import Snowpunk.powers.LambdaPower;

import static Snowpunk.SnowpunkMod.makeID;
import static Snowpunk.util.Wiz.applyToSelf;
...
public class InlinePowerDemo extends AbstractEasyCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        applyToSelf(new LambdaPower(makeID("StrikeUpBlockUp"), "Strike+, Block+", AbstractPower.PowerType.BUFF, false, p, magicNumber) {
            @Override
