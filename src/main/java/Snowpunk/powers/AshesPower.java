...
public class AshesPower extends AbstractEasyPower {
    public static String POWER_ID = makeID(AshesPower.class.getSimpleName());
    public static PowerStrings strings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static String[] DESCRIPTIONS = strings.DESCRIPTIONS;

    public AshesPower(AbstractCreature owner, int amount) {
