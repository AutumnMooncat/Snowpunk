...
public class RandomChatterHelper {
    ...
    private static final CardStrings AttackTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("AttackTextContainer"));

    private static final CardStrings SkillTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("SkillTextContainer"));

    private static final CardStrings PowerTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("PowerTextContainer"));

    private static final CardStrings BattleStartTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("BattleStartTextContainer"));

    private static final CardStrings LowHPBattleStartTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("LowHPBattleStartTextContainer"));

    private static final CardStrings BattleEndTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("BattleEndTextContainer"));

    private static final CardStrings BossFightTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("BossFightTextContainer"));

    private static final CardStrings HealingTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("HealingTextContainer"));

    private static final CardStrings FieldDamageTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("FieldDamageTextContainer"));

    private static final CardStrings LightDamageTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("LightDamageTextContainer"));

    private static final CardStrings HeavyDamageTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("HeavyDamageTextContainer"));

    private static final CardStrings BlockedDamageTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("BlockedDamageTextContainer"));

    private static final CardStrings KOTextContainer = CardCrawlGame.languagePack.getCardStrings(SnowpunkMod.makeID("KOTextContainer"));
